...
const memberToPromote = new QualifiedId('member-user-id', 'member-domain.com')

await applicationManager.updateConversationMemberRole(myConversationId, memberToPromote, ConversationRole.ADMIN)
```
