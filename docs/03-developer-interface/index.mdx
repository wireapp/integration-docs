...
2. Performing actions using the `WireApplicationManager`
...
Here are some example of things you can do via the SDK to interact with the Wire ecosystem with your App:
 ...
 - [Sending messages](02-interactions/01-send-message.mdx)
 - [Managing teams and conversations](02-interactions/02-teams-and-conversations.mdx)
 - [Creating conversations](02-interactions/03-create-conversation.mdx)
 - [Deleting conversations](02-interactions/04-delete-conversation.mdx)
 - [Leaving conversations](02-interactions/05-leave-conversation.mdx)
 - [Adding members to a conversation](02-interactions/06-add-members-to-conversation.mdx)
 - [Listing members of a conversation](02-interactions/07-list-conversation-members.mdx)
