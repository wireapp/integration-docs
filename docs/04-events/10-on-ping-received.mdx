...
The `WireMessage.Ping` has [Base](./02-message-model.md#base-message-properties) and [Ephemeral](./02-message-model.md#ephemeral-message-properties) message properties.
