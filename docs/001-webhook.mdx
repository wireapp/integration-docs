...
See [creating conversations](./03-developer-interface/02-interactions/03-create-conversation.mdx) for how to create group and one-to-one conversations with the SDK.
