...
You will be able to Create an App from [Team management](./create-app.md), 
...
[//]: # (<ReactPlayer width="100%" controls src='https://drive.google.com/file/d/1ssrPVGFAXUmaq7CjDeZJDyXnGPcwlwgo/preview' />)

<iframe src="https://drive.google.com/file/d/1ssrPVGFAXUmaq7CjDeZJDyXnGPcwlwgo/preview" width="100%" height="auto"></iframe>
...
## 4. Create a Storage Directory

Click on + icon and create a Storage Directory

![img.png](../assets/team-management/storage_in_project_fs.png)

## 5. Create Your Kotlin File
