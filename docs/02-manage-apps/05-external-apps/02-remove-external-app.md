...
> Looking to delete an app your team owns instead? [See how to delete an internal app](../04-delete-app.md).
...
![three dots](/img/team-management/external_integrations_tab_three_dots.png)

5. Select *Remove app*.

![remove external app](/img/team-management/external_app_remove.png)
