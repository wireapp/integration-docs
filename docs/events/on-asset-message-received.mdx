...
Apart from [Base, Ephemeral, and Replyable properties](../core-concepts/message-model.md) `WireMessage.Asset` object contains the following fields:
...
<!-- TODO: downloadAssetSuspending not accessible in java -->
</Tabs>
