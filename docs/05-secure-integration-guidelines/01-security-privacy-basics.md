...
If you are creating a new app from the Wire Team interface, as described [in the creation workflow](../02-manage-apps/01-create-app.mdx), you receive an **App ID** and an **App Token**.
